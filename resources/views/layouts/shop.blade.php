...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- cart -->
    <!--start-rate-->
    <script src="{{asset('shop/js/jstarbox.js')}}"></script>
    <link rel="stylesheet" href="{{asset('shop/css/jstarbox.css')}}" type="text/css" media="screen" charset="utf-8" />
...
<body>
<!--header-->
@include('patials.header_shop')
<!--header-->
@yield('content')
<!---footer--->
@include('patials.footer_shop')
<!---footer--->
<!--copy-->
            ...
            <div class="modal-body">
                <div class="news-gr">
                    <div class="col-md-5 new-grid1">
                        <img src="{{asset('shop/images/p5.jpg')}}" class="img-responsive" alt="">
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-info">
            ...
            <div class="modal-body">
                <div class="news-gr">
                    <div class="col-md-5 new-grid1">
                        <img src="{{asset('shop/images/p7.jpg')}}" class="img-responsive" alt="">
                    </div>
                    <div class="col-md-7 new-grid">
                        <h5>Ten Women's Cotton Viscose fabric Grey Shrug</h5>
                        <h6>Quick Overview</h6>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-info">
            ...
            <div class="modal-body">
                <div class="news-gr">
                    <div class="col-md-5 new-grid1">
                        <img src="{{asset('shop/images/p10.jpg')}}" class="img-responsive" alt="">
                    </div>
                    <div class="col-md-7 new-grid">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-info">
            ...
            <div class="modal-body">
                <div class="news-gr">
                    <div class="col-md-5 new-grid1">
                        <img src="{{asset('shop/images/p12.jpg')}}" class="img-responsive" alt="">
                    </div>
                    <div class="col-md-7 new-grid">
                        <h5>Ten Men's Cotton Viscose fabric Grey Shrug</h5>
                        <h6>Quick Overview</h6>
